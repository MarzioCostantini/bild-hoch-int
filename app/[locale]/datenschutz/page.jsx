...
export const metadata = {
  title: "Datenschutz | Euer Hochzeitsfotograf in München",
  description: "Datenschutzerklärung von Hochzeitsfotograf in München",
};
const datenschutz = () => {
  return (
    <>
      <main className={styles.datenschutz}>
        ...
        <article>
          <p>
            ...
            Geschäftsleitung der Marzio Costantini Photography. Eine Nutzung der
            Internetseiten der Marzio Costantini Photography ist grundsätzlich
            ...
            generell eine Einwilligung der betroffenen Person ein. Die
            ...
            Marzio Costantini Photography geltenden landesspezifischen
            ...
            Die Marzio Costantini Photography hat als für die Verarbeitung
          ...
          <p>
            <span>1. Begriffsbestimmungen</span>
            Die Datenschutzerklärung der Marzio Costantini Photography beruht
            auf den Begrifflichkeiten, die durch den Europäischen Richtlinien-
            ...
            erläutern. Wir verwenden in dieser Datenschutzerklärung unter
            anderem die folgenden Begriffe:
          </p>
          <p>
            <span>a) personenbezogene Daten</span>
            ...
            <span>h) Auftragsverarbeiter</span>
          ...
          <p>
            ...
            datenschutzrechtlichem Charakter ist die: Marzio Costantini
            Photography Dorfbachweg 1 82490 Farchant Deutschland Tel.: +49 157
            71069791 E-Mail: info@bild-hochzeit.de Website: www.Bild-Hochzeit.de
          </p>
          <p>
            <span>3. Cookies</span>
            Die Internetseiten der Marzio Costantini Photography verwenden
            Cookies. Cookies sind Textdateien, welche über einen Internetbrowser
            auf einem Computersystem abgelegt und gespeichert werden. Zahlreiche
            ...
            Cookies kann die Marzio Costantini Photography den Nutzern dieser
            Internetseite nutzerfreundlichere Services bereitstellen, die ohne
            die Cookie-Setzung nicht möglich wären. Mittels eines Cookies können
            die Informationen und Angebote auf unserer Internetseite im Sinne
            des Benutzers optimiert werden. Cookies ermöglichen uns, wie bereits
            ...
            durch unsere Internetseite jederzeit mittels einer entsprechenden
          ...
          <p>
            <span>4. Erfassung von allgemeinen Daten und Informationen</span>
            Die Internetseite der Marzio Costantini Photography erfasst mit
            ...
            Marzio Costantini Photography keine Rückschlüsse auf die betroffene
            ...
            Informationen werden durch die Marzio Costantini Photography daher
          ...
          <p>
            <span>5. Kontaktmöglichkeit über die Internetseite</span>
            Die Internetseite der Marzio Costantini Photography enthält aufgrund
            von gesetzlichen Vorschriften Angaben, die eine schnelle
          ...
          <p>
            <span>6. Kommentarfunktion im Blog auf der Internetseite</span>
            Die Marzio Costantini Photography bietet den Nutzern auf einem Blog,
            der sich auf der Internetseite des für die Verarbeitung
            Verantwortlichen befindet, die Möglichkeit, individuelle Kommentare
            zu einzelnen Blog-Beiträgen zu hinterlassen. Ein Blog ist ein auf
            ...
            in der Regel von Dritten kommentiert werden. Hinterlässt eine
            ...
            Kommentareingabe sowie zu dem von der betroffenen Person gewählten
            Nutzernamen (Pseudonym) gespeichert und veröffentlicht. Ferner wird
            die vom Internet-Service-Provider (ISP) der betroffenen Person
            vergebene IP-Adresse mitprotokolliert. Diese Speicherung der
            ...
            Dritter verletzt oder rechtswidrige Inhalte postet. Die Speicherung
            dieser personenbezogenen Daten erfolgt daher im eigenen Interesse
            des für die Verarbeitung Verantwortlichen, damit sich dieser im
            Falle einer Rechtsverletzung gegebenenfalls exkulpieren könnte. Es
            erfolgt keine Weitergabe dieser erhobenen personenbezogenen Daten an
          ...
          <p>
            <span>8. Rechte der betroffenen Person</span>
            <span>a) Recht auf Bestätigung</span>
            ...
            <span>b) Recht auf Auskunft</span>
            ...
            <span>c) Recht auf Berichtigung</span>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
            ...
            <span>d) Recht auf Löschung (Recht auf Vergessen werden)</span>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
            ...
            Verarbeitung nicht erforderlich ist: Die personenbezogenen Daten
            wurden für solche Zwecke erhoben oder auf sonstige Weise
            verarbeitet, für welche sie nicht mehr notwendig sind. Die
            ...
            Rechtsgrundlage für die Verarbeitung. Die betroffene Person legt
            gemäß Art. 21 Abs. 1 DS-GVO Widerspruch gegen die Verarbeitung ein,
            und es liegen keine vorrangigen berechtigten Gründe für die
            Verarbeitung vor, oder die betroffene Person legt gemäß Art. 21 Abs.
            ...
            Person die Löschung von personenbezogenen Daten, die bei der Marzio
            Costantini Photography gespeichert sind, veranlassen möchte, kann
            sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Marzio
            Costantini Photography wird veranlassen, dass dem Löschverlangen
            unverzüglich nachgekommen wird. Wurden die personenbezogenen Daten
            von der Marzio Costantini Photography öffentlich gemacht und ist
            unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO
            zur Löschung der personenbezogenen Daten verpflichtet, so trifft die
            Marzio Costantini Photography unter Berücksichtigung der verfügbaren
            ...
            Mitarbeiter der Marzio Costantini Photography wird im Einzelfall das
            Notwendige veranlassen.
            <span>e) Recht auf Einschränkung der Verarbeitung</span>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
            ...
            betroffenen Person überwiegen. Sofern eine der oben genannten
            Voraussetzungen gegeben ist und eine betroffene Person die
            Einschränkung von personenbezogenen Daten, die bei der Marzio
            Costantini Photography gespeichert sind, verlangen möchte, kann sie
            sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Marzio Costantini
            Photography wird die Einschränkung der Verarbeitung veranlassen.
            <span>f) Recht auf Datenübertragbarkeit</span>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Marzio
            Costantini Photography wenden.
            <span>g) Recht auf Widerspruch</span>
            Jede von der Verarbeitung personenbezogener Daten betroffene Person
            hat das vom Europäischen Richtlinien- und Verordnungsgeber gewährte
            ...
            Bestimmungen gestütztes Profiling. Die Marzio Costantini Photography
            ...
            für die Verarbeitung nachweisen, die den Interessen, Rechten und
            ...
            Rechtsansprüchen. Verarbeitet die Marzio Costantini Photography
            ...
            betroffene Person gegenüber der Marzio Costantini Photography der
            Verarbeitung für Zwecke der Direktwerbung, so wird die Marzio
            Costantini Photography die personenbezogenen Daten nicht mehr für
            ...
            die sie betreffende Verarbeitung personenbezogener Daten, die bei
            der Marzio Costantini Photography zu wissenschaftlichen oder
            ...
            Interesse liegenden Aufgabe erforderlich. Zur Ausübung des Rechts
            auf Widerspruch kann sich die betroffene Person direkt jeden
            Mitarbeiter der Marzio Costantini Photography oder einen anderen
            ...
            Marzio Costantini Photography angemessene Maßnahmen, um die Rechte
          ...
          <p>
            ...
            Facebook ist ein soziales Netzwerk. Ein soziales Netzwerk ist ein im
            Internet betriebener sozialer Treffpunkt, eine Online-Gemeinschaft,
            die es den Nutzern in der Regel ermöglicht, untereinander zu
            ...
            durch die betroffene Person besucht wird. Sofern die betroffene
            Person gleichzeitig bei Facebook eingeloggt ist, erkennt Facebook
            mit jedem Aufruf unserer Internetseite durch die betroffene Person
            ...
            ordnet Facebook diese Information dem persönlichen
            Facebook-Benutzerkonto der betroffenen Person zu und speichert diese
            personenbezogenen Daten. Facebook erhält über die
            Facebook-Komponente immer dann eine Information darüber, dass die
            ...
            gleichzeitig bei Facebook eingeloggt ist; dies findet unabhängig
            davon statt, ob die betroffene Person die Facebook-Komponente
            ...
            ausloggt. Die von Facebook veröffentlichte Datenrichtlinie, die
          ...
          <p>
            ...
            Inc., 1600 Amphitheatre Pkwy, Mountain View, CA 94043-1351, USA. Der
            ...
            Europäischen Wirtschaftsraum erfolgt. Der Zweck der
            ...
            personenbezogene Informationen, beispielsweise die Zugriffszeit, der
            Ort, von welchem ein Zugriff ausging und die Häufigkeit der Besuche
            unserer Internetseite durch die betroffene Person, gespeichert. Bei
            jedem Besuch unserer Internetseiten werden diese personenbezogenen
            Daten, einschließlich der IP-Adresse des von der betroffenen Person
            ...
            Daten unter Umständen an Dritte weiter. Die betroffene Person kann
            die Setzung von Cookies durch unsere Internetseite, wie oben bereits
            dargestellt, jederzeit mittels einer entsprechenden Einstellung des
            genutzten Internetbrowsers verhindern und damit der Setzung von
            Cookies dauerhaft widersprechen. Eine solche Einstellung des
            genutzten Internetbrowsers würde auch verhindern, dass Google ein
            Cookie auf dem informationstechnologischen System der betroffenen
            Person setzt. Zudem kann ein von Google Analytics bereits gesetzter
            ...
            erzeugten, auf eine Nutzung dieser Internetseite bezogenen Daten
            sowie der Verarbeitung dieser Daten durch Google zu widersprechen
          ...
          <p>
            ...
            Freundschaftsanfragen. Betreibergesellschaft von Google+ ist die
            Google Inc., 1600 Amphitheatre Pkwy, Mountain View, CA 94043-1351,
            USA. Durch jeden Aufruf einer der Einzelseiten dieser Internetseite,
            die durch den für die Verarbeitung Verantwortlichen betrieben wird
            und auf welcher eine Google+ Schaltfläche integriert wurde, wird der
            ...
            https://developers.google.com/+/ abrufbar. Sofern die betroffene
            Person gleichzeitig bei Google+ eingeloggt ist, erkennt Google mit
            ...
            Google+-Account der betroffenen Person zugeordnet. Betätigt die
            ...
            diesbezüglich akzeptierten Bedingungen öffentlich zugänglich. Eine
            von der betroffenen Person auf dieser Internetseite abgegebene
            ...
            optimieren. Google erhält über die Google+-Schaltfläche immer dann
            ...
            des Aufrufs unserer Internetseite gleichzeitig bei Google+
            eingeloggt ist; dies findet unabhängig davon statt, ob die
            betroffene Person die Google+-Schaltfläche anklickt oder nicht. Ist
            eine Übermittlung personenbezogener Daten an Google von der
          ...
          <p>
            ...
            Inc., 1600 Amphitheatre Pkwy, Mountain View, CA 94043-1351, USA. Der
            Zweck von Google AdWords ist die Bewerbung unserer Internetseite
            ...
            Einblendung von Fremdwerbung auf unserer Internetseite. Gelangt eine
            betroffene Person über eine Google-Anzeige auf unsere Internetseite,
            wird auf dem informationstechnologischen System der betroffenen
            Person durch Google ein sogenannter Conversion-Cookie abgelegt. Was
            Cookies sind, wurde oben bereits erläutert. Ein Conversion-Cookie
            verliert nach dreißig Tagen seine Gültigkeit und dient nicht zur
            Identifikation der betroffenen Person. Über den Conversion-Cookie
            wird, sofern das Cookie noch nicht abgelaufen ist, nachvollzogen, ob
            ...
            generierte, also einen Warenkauf vollzogen oder abgebrochen hat. Die
            durch die Nutzung des Conversion-Cookies erhobenen Daten und
            ...
            betroffene Person identifiziert werden könnte. Mittels des
            Conversion-Cookies werden personenbezogene Informationen,
            ...
            von Cookies durch unsere Internetseite, wie oben bereits
            dargestellt, jederzeit mittels einer entsprechenden Einstellung des
            genutzten Internetbrowsers verhindern und damit der Setzung von
            Cookies dauerhaft widersprechen. Eine solche Einstellung des
            ...
            betroffenen Person setzt. Zudem kann ein von Google AdWords bereits
            gesetzter Cookie jederzeit über den Internetbrowser oder andere
            Softwareprogramme gelöscht werden. Ferner besteht für die betroffene
            Person die Möglichkeit, der interessenbezogenen Werbung durch Google
            zu widersprechen. Hierzu muss die betroffene Person von jedem der
          ...
          <p>
            ...
            Netzwerken ermöglicht. Betreibergesellschaft der Dienste von
            Instagram ist die Instagram LLC, 1 Hacker Way, Building 14 First
            Floor, Menlo Park, CA, USA. Durch jeden Aufruf einer der
            ...
            konkrete Unterseite unserer Internetseite durch die betroffene
            Person besucht wird. Sofern die betroffene Person gleichzeitig bei
            Instagram eingeloggt ist, erkennt Instagram mit jedem Aufruf unserer
            Internetseite durch die betroffene Person und während der gesamten
            Dauer des jeweiligen Aufenthaltes auf unserer Internetseite, welche
            konkrete Unterseite die betroffene Person besucht. Diese
            Informationen werden durch die Instagram-Komponente gesammelt und
            durch Instagram dem jeweiligen Instagram-Account der betroffenen
            Person zugeordnet. Betätigt die betroffene Person einen der auf
            unserer Internetseite integrierten Instagram-Buttons, werden die
            ...
            Instagram gespeichert und verarbeitet. Instagram erhält über die
            Instagram-Komponente immer dann eine Information darüber, dass die
            betroffene Person unsere Internetseite besucht hat, wenn die
            betroffene Person zum Zeitpunkt des Aufrufs unserer Internetseite
            gleichzeitig bei Instagram eingeloggt ist; dies findet unabhängig
            davon statt, ob die betroffene Person die Instagram-Komponente
            anklickt oder nicht. Ist eine derartige Übermittlung dieser
            Informationen an Instagram von der betroffenen Person nicht gewollt,
            kann diese die Übermittlung dadurch verhindern, dass sie sich vor
            einem Aufruf unserer Internetseite aus ihrem Instagram-Account
            ausloggt. Weitere Informationen und die geltenden
          ...
          <p>
            <span>
              14. Datenschutzbestimmungen zu Einsatz und Verwendung von Jetpack
              für WordPress
            </span>
            Der für die Verarbeitung Verantwortliche hat auf dieser
            ...
            Internetseite integrierten Bilder. Betreibergesellschaft des
            Jetpack-Plug-Ins für WordPress ist die Automattic Inc., 132
            Hawthorne Street, San Francisco, CA 94107, USA. Die
            Betreibergesellschaft setzt die Trackingtechnologie der Quantcast
            Inc., 201 Third Street, San Francisco, CA 94103, USA, ein. Jetpack
            setzt ein Cookie auf dem informationstechnologischen System der
            betroffenen Person. Was Cookies sind, wurde oben bereits erläutert.
            Durch jeden Aufruf einer der Einzelseiten dieser Internetseite, die
            durch den für die Verarbeitung Verantwortlichen betrieben wird und
            auf welcher eine Jetpack-Komponente integriert wurde, wird der
            Internetbrowser auf dem informationstechnologischen System der
            betroffenen Person automatisch durch die jeweilige
            ...
            Opt-Out-Cookie setzen. Mit der Setzung des Opt-Out-Cookies besteht
            jedoch die Möglichkeit, dass die Internetseiten des für die
            Verarbeitung Verantwortlichen für die betroffene Person nicht mehr
            vollumfänglich nutzbar sind. Die geltenden Datenschutzbestimmungen
            von Automattic sind unter https://automattic.com/privacy/ abrufbar.
          ...
          <p>
            ...
            ist ein sogenanntes soziales Netzwerk. Ein soziales Netzwerk ist ein
            im Internet betriebener sozialer Treffpunkt, eine
            Online-Gemeinschaft, die es den Nutzern in der Regel ermöglicht,
            untereinander zu kommunizieren und im virtuellen Raum zu
            interagieren. Ein soziales Netzwerk kann als Plattform zum Austausch
            von Meinungen und Erfahrungen dienen oder ermöglicht es der
            Internetgemeinschaft, persönliche oder unternehmensbezogene
            Informationen bereitzustellen. Pinterest ermöglicht den Nutzern des
            sozialen Netzwerkes unter anderem, Bilderkollektionen und
            Einzelbilder sowie Beschreibungen an virtuellen Pinnwänden zu
            veröffentlichen (sogenanntes pinnen), welche dann wiederum von
            anderen Nutzern geteilt (sogenanntes repinnen) oder kommentiert
            werden können. Betreibergesellschaft von Pinterest ist die Pinterest
            Inc., 808 Brannan Street, San Francisco, CA 94103, USA. Durch jeden
            ...
            eine Pinterest-Komponente (Pinterest-Plug-In) integriert wurde, wird
            der Internetbrowser auf dem informationstechnologischen System der
            betroffenen Person automatisch durch die jeweilige
            Pinterest-Komponente veranlasst, eine Darstellung der entsprechenden
            Pinterest-Komponente von Pinterest herunterzuladen. Mehr
            Informationen zu Pinterest sind unter https://pinterest.com/
            abrufbar. Im Rahmen dieses technischen Verfahrens erhält Pinterest
            Kenntnis darüber, welche konkrete Unterseite unserer Internetseite
            durch die betroffene Person besucht wird. Sofern die betroffene
            Person gleichzeitig bei Pinterest eingeloggt ist, erkennt Pinterest
            mit jedem Aufruf unserer Internetseite durch die betroffene Person
            und während der gesamten Dauer des jeweiligen Aufenthaltes auf
            unserer Internetseite, welche konkrete Unterseite unserer
            Internetseite die betroffene Person besucht. Diese Informationen
            werden durch die Pinterest-Komponente gesammelt und durch Pinterest
            dem jeweiligen Pinterest-Account der betroffenen Person zugeordnet.
            Betätigt die betroffene Person einen auf unserer Internetseite
            integrierten Pinterest-Button, ordnet Pinterest diese Information
            dem persönlichen Pinterest-Benutzerkonto der betroffenen Person zu
            und speichert diese personenbezogenen Daten. Pinterest erhält über
            die Pinterest-Komponente immer dann eine Information darüber, dass
            die betroffene Person unsere Internetseite besucht hat, wenn die
            betroffene Person zum Zeitpunkt des Aufrufs unserer Internetseite
            gleichzeitig bei Pinterest eingeloggt ist; dies findet unabhängig
            davon statt, ob die betroffene Person die Pinterest-Komponente
            anklickt oder nicht. Ist eine derartige Übermittlung dieser
            Informationen an Pinterest von der betroffenen Person nicht gewollt,
            kann diese die Übermittlung dadurch verhindern, dass sie sich vor
            einem Aufruf unserer Internetseite aus ihrem Pinterest-Account
            ausloggt. Die von Pinterest veröffentlichte Datenschutzrichtlinie,
            die unter https://about.pinterest.com/privacy-policy abrufbar ist,
          ...
          <p>
            ...
            PayPal-Konten abgewickelt, die virtuelle Privat- oder
            Geschäftskonten darstellen. Zudem besteht bei PayPal die
            Möglichkeit, virtuelle Zahlungen über Kreditkarten abzuwickeln, wenn
            ein Nutzer kein PayPal-Konto unterhält. Ein PayPal-Konto wird über
            eine E-Mail-Adresse geführt, weshalb es keine klassische Kontonummer
            gibt. PayPal ermöglicht es, Online-Zahlungen an Dritte auszulösen
            oder auch Zahlungen zu empfangen. PayPal übernimmt ferner
            Treuhänderfunktionen und bietet Käuferschutzdienste an. Die
            Europäische Betreibergesellschaft von PayPal ist die PayPal (Europe)
            S.à.r.l. & Cie. S.C.A., 22-24 Boulevard Royal, 2449 Luxembourg,
            Luxemburg. Wählt die betroffene Person während des Bestellvorgangs
            in unserem Online-Shop als Zahlungsmöglichkeit „PayPal“ aus, werden
            ...
            personenbezogener Daten ein. Bei den an PayPal übermittelten
            personenbezogenen Daten handelt es sich in der Regel um Vorname,
            Nachname, Adresse, Email-Adresse, IP-Adresse, Telefonnummer,
            ...
            jeweiligen Bestellung stehen. Die Übermittlung der Daten bezweckt
            die Zahlungsabwicklung und die Betrugsprävention. Der für die
            Verarbeitung Verantwortliche wird PayPal personenbezogene Daten
            insbesondere dann übermitteln, wenn ein berechtigtes Interesse für
            ...
            verarbeitet werden sollen. Die betroffene Person hat die
            Möglichkeit, die Einwilligung zum Umgang mit personenbezogenen Daten
            jederzeit gegenüber PayPal zu widerrufen. Ein Widerruf wirkt sich
            nicht auf personenbezogene Daten aus, die zwingend zur
          ...
          <p>
            <span>17. Rechtsgrundlage der Verarbeitung</span>
          ...
          <p>
            <span>21. Bestehen einer automatisierten Entscheidungsfindung</span>
